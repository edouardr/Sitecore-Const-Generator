namespace Sitecore.Helix.ConstGenerator.Infrastructure.Api
{
    ...
    public class RestApi : IRestApi
    {
            ...
            bool useAuthenticateRequest = false)
        {
            ...
            if (string.IsNullOrEmpty(BaseUrl))
                throw new ArgumentNullException(nameof(baseUrl),
                    @"The base Url is mandatory to create a REST API client.");
        }
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentException"></exception>
        public virtual RestRequest BuildRequest<T>(Dictionary<T, string> urls, T type, Method method,
            params object[] args)
        {
            var request = new RestRequest();
            string constUrl;
            ...
            if (!token.IsCancellationRequested
                ...
                client.ExecuteAsync<T>(request, (response, handle) =>
                {
                    ...
                    if (response.ErrorException != null)
                    {
                        ...
                        throw new NotSupportedException(response.ErrorException.Message,
